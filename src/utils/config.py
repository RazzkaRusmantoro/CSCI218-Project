"""
Game configuration constants for the Turn-Based Fighter Game.
Contains all tunable parameters for game balance, moves, AI, and mechanics.
"""

# ============================================================================
# BASIC MOVE CONSTANTS
# ============================================================================
...
# Used for FSM display and as reference for difficulty modifiers
AI_ACTION_WEIGHTS = {
    'aggressive': {
